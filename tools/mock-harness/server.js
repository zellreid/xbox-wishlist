...
//   -> then open http://localhost:<port>/mock_examples/wishlist/en-za/<name>.harness.html
...
server.listen(PORT, () => {
    ...
    console.log(`Prepared fixtures: http://localhost:${PORT}/mock_examples/wishlist/en-za/<name>.harness.html`);
});

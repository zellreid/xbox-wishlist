...
//   -> then open http://localhost:<port>/mock_examples/prepared/<name>.harness.html
...
server.listen(PORT, () => {
    ...
    console.log(`Prepared fixtures: http://localhost:${PORT}/mock_examples/<name>.harness.html`);
});

...
phase: Live
priority: Medium
next_milestone: Live check of T-19 + F-39 with the theme switch fixes (v1.5.26267.4); then F-40 DLC indicator
target_date: none
hard_deadline: false
blockers: []
...
|---|---|---|---|---|
| T-19 | Light mode styling fix (+ F-39 theme switch) | High | In Progress | Live check on xbox.com with the Theme button: header, BUY buttons, toolbar, our panels and chips in both modes |

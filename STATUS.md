...
## Now
- Live at v1.5.26266.20. T-16 (F-36 Load details) confirmed on live Edge.
...
|---|---|---|---|---|
| T-18 | Live check of per-item refresh and Type filter in Edge (v1.5.26266.20) | High | Todo | Reload the extension; refresh one item (and a duplicated one), tick DLC in Type |

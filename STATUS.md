...
phase: Live
priority: Medium
next_milestone: Live check of v1.5.26269.4 on en-ZA and en-US (price history, range per currency, currency format, Stored data buttons); then T-29 and the date added / pass entitlement features
target_date: none
hard_deadline: false
blockers: []
...
|---|---|---|---|---|
| T-27 | Live check of v1.5.26269.4: per-market price history, price range per currency, currency format | High | In Progress | en-ZA: old history and range intact, number style R 948,27; en-US: empty history, no price filter, $ prices; switch back and check the rand range returned |
...
| T-33 | Stored data buttons in the userscript: find other markets' price history (needs the GM_listValues and GM_deleteValue grants) | Low | Todo | HITL: approve the two new @grant lines in the userscript header, or accept the current-market-only limit |
